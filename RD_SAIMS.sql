...
INSERT INTO `tbl_person`(`Person_Id`,`Firstname`,`Lastname`,`Designation`,`Contact_Number`,`Address`) VALUES(4,'John','Doe',NULL,'09353536418','Bawing, General Santos City');
...
INSERT INTO `tbl_user`(`Person_Id`,`Role_Id`,`Username`,`Password`,`ImagePath`,`Status`) VALUES(4,1,'admin','LSc2BWtfPkEDiSRYPTEsrDtEf7dal4mYz2A2/7W57UY=','John.jpg','Active');
...
-- Dump completed on 2022-01-15 11:07:35
-- Total time: 0:0:0:1:81 (d:h:m:s:ms)
